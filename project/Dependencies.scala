...
object Dependencies {
  ...
  private val jGivenVersion = "1.2.0"
  ...
  lazy val `log4j-slf4j-impl` = "org.apache.logging.log4j" % "log4j-slf4j-impl" % "2.17.2" % Test
  lazy val scalatest = "org.scalatest" %% "scalatest" % "3.2.11"
  lazy val `slf4j-api` = "org.slf4j" % "slf4j-api" % "1.7.35"
